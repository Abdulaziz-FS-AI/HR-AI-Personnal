...
export function QuestionsBuilder({ 
  ...
  const validateQuestion = (text: string) => {
    ...
    if (text.length < 10) return { isValid: false, message: "Question too short" }
    if (text.length > 1000) return { isValid: false, message: "Question too long" }
    ...
    if (!hasQuestionMark && !hasQuestionWord) {
      return { 
        isValid: false, 
        message: "Question should end with '?' or contain question words" 
      }
    }
    ...
    <Card className="w-full max-w-6xl mx-auto">
      <CardHeader>
        ...
        <p className="text-center text-muted-foreground">
          Step 3 of 4: Add role-specific questions for candidate evaluation (optional)
        </p>
      </CardHeader>
